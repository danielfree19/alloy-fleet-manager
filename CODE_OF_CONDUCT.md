...
the Alloy Fleet Manager (OSS) project a harassment-free experience for
...
This Code of Conduct applies within all community spaces — issues, merge
requests, the project chat (if any), and any space where someone is
representing the project — and also applies when an individual is
officially representing the community in public spaces.

## Reporting

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the maintainers via the contact address listed in
