...
<!-- Describe what this MR changes, in one or two short paragraphs.
Use the *imperative* voice ("Add support for X") matching Conventional
Commits — the title and merge commit are derived from this. -->

### Why

<!-- Why is this change worth doing? Link the GitLab issue if there is
one (`Closes #123`). -->
...
- [ ] No new dependency added without justifying it in the MR description
